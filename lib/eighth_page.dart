...
final datasques = [
  {'no': 15, 'qndes': 'Question Description', 'qn': 'Infinity'},
];
...
class eighth_page extends StatefulWidget {
  const eighth_page({Key? key}) : super(key: key);

  @override
  _MyWidgetState createState() => _MyWidgetState();
}

class _MyWidgetState extends State<eighth_page> {
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text('Submit', style: TextStyle(fontWeight: FontWeight.w500))),
                              ),
                            ),
                          ],
                        ),
